...
> **🎮 WWM Tradutor PT-BR**  
> Instale, atualize e gerencie a tradução com apenas **um clique**!

[![Download Launcher](https://img.shields.io/badge/⬇️_BAIXAR_LAUNCHER-v2.0.0-00ff00?style=for-the-badge&logo=windows)](https://github.com/rodrigomiquilino/wwm_brasileiro/releases/latest)
...
|:-----:|:-----|:-----------:|
| **1** | Acessa o site de tradução | 👤 Usuário |
| **2** | Faz login com GitHub | 👤 Usuário |
| **3** | Envia sugestão de tradução | 👤 Usuário |
| **4** | Issue é criada automaticamente | 🤖 Sistema |
| **5** | Revisor analisa a sugestão | 🔍 Revisor |
| **6a** | ✅ `approved` → GitHub Action aplica tradução | 🤖 Automação |
| **6b** | ❌ `rejected` → Comentário explicando motivo | 🔍 Revisor |
| **7** | Issue fechada automaticamente | 🤖 Sistema |
